...
class User:
                        ...
                        if self.active:
                            if event.key == pg.K_RETURN:
                                if self.text == self.work_w_csv('correct_answer'):
                                    ...
                                    xx, yy = self.board.get_cell((x + int(self.cellsize / 2), y + int(self.cellsize / 2)))
                                    print(xx,yy)
    ...
    def close_the_question(self):
        verdicttext = 'correct' if self.verdict else 'not correct'
        ...
        self.screen.blit(pg.font.Font(None, 32).render('>Далее', True, pg.Color('black')), (self.close_questionrect.x + 5, self.close_questionrect.y + 5))

        pg.draw.rect(self.screen, pg.Color('white'), self.verdict_rect, 2)
        self.screen.blit(pg.font.Font(None, 32).render(verdicttext, True, color), (305, 320))
